...
public class RelayCommand : CommandBase
{
    ...
    protected override void Execute() => _execute();
...
public class RelayCommand<T> : CommandBase<T>
{
    ...
    /// <summary>Gets a value indicating whether the command can execute in its current state. </summary>
    [DebuggerStepThrough]
    public override bool CanExecute(T parameter) => _canExecute == null || _canExecute(parameter);

    /// <summary>Defines the method to be called when the command is invoked. </summary>
    protected override void Execute(T parameter) => _execute(parameter);
}